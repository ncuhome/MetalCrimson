...
namespace ER.Entity2D
{
    ...
    public class Entity : MonoBehaviour
    {
        ...
        /// 在指定 特征添加进后 触发的委托
        /// </summary>
        protected struct ConditionalDelegation
        {
            /// <summary>
            /// 条件特征名称
            /// </summary>
        ...
        /// 实体的特征对象(使用特征名称作为索引)
        /// </summary>
        protected Dictionary<string, IAttribute> attributes = new();

        /// <summary>
        /// 条件委托列表
        /// </summary>

        protected List<ConditionalDelegation> delegations = new();
        ...
        /// 尝试触发条件委托
        /// </summary>
        protected void JudgeDelegation(IAttribute attribute)
        {
